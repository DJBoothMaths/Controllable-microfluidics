...
%%
[cPe4,ubotPe4,utopPe4,f4] = advdiff(N, L, H, Abot, Atop,100, 4, cPe4);
%%
tend = 100;
dt = 0.01;
[xtrajPe,ytrajPe] = trajectory1(N,L,H, 5.3,1, f4, ubotPe4, utopPe4, tend, dt);
%%
tend = 100;
dt = 0.01;
[xtrajPe2,ytrajPe2] = trajectory1(N,L,H, 4.7,1, f4, ubotPe4, utopPe4, tend, dt);
%%
tend = 250;
dt = 0.01;
[xtrajPe3,ytrajPe3] = trajectory1(N,L,H, 5.2,1, f4, ubotPe4, utopPe4, tend, dt);
%%
tend = 250;
dt = 0.01;
[xtrajPe4,ytrajPe4] = trajectory1(N,L,H, 4.8,1, f4, ubotPe4, utopPe4, tend, dt);
%%
tend = 50;
dt = 0.01;
[xtrajPe5,ytrajPe5] = trajectory1(N,L,H, 5.9,1, f4, ubotPe4, utopPe4, tend, dt);
%%
tend = 50;
dt = 0.01;
[xtrajPe6,ytrajPe6] = trajectory1(N,L,H, 4.1,1, f4, ubotPe4, utopPe4, tend, dt);
%%
...
% hold on 
% plot3(xtrajPe2,ytrajPe2,50*ones(length(xtrajPe2),1),'k','LineWidth',1)
...
daspect([1 1 1])
axis off
exportgraphics(gca, '/Users/danielbooth/Documents/Warwick/MATLAB/BEM/ThinDroplets/tikz/Pe4.png', 'Resolution', 600)
%%
figure
...
%hold off
axis off
matlab2tikz('/Users/danielbooth/Documents/Warwick/MATLAB/BEM/ThinDroplets/tikz/Pe4.tex')