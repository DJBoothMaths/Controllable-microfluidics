...
Atop = zeros(N,1);
Atop(.5*(N-1)+1-(N-1)/L:0.5*(N-1)+1+(N-1)/L)=-1;
...
tend = 50;
dt = 0.01;
[xtraj7,ytraj7] = trajectory1(N,L,H, 4.1,2, f, ubot, utop, tend, dt);
%%
tend = 50;
dt = 0.01;
[xtraj8,ytraj8] = trajectory1(N,L,H, 5.9,2, f, ubot, utop, tend, dt);
%%
tend = 250;
dt = 0.01;
[xtraj9,ytraj9] = trajectory1(N,L,H, 5.1,2, f, ubot, utop, tend, dt);
%%
tend = 250;
dt = 0.01;
[xtraj10,ytraj10] = trajectory1(N,L,H, 4.9,2, f, ubot, utop, tend, dt);
%%
tend = 250;
dt = 0.005;
[xtraj11,ytraj11] = trajectory1(N,L,H, 4.7,2, f, ubot, utop, tend, dt);
%%
tend = 250;
dt = 0.005;
[xtraj12,ytraj12] = trajectory1(N,L,H, 5.3,2, f, ubot, utop, tend, dt);
%%
figure
