function [xtraj,ytraj] = trajectory1(N,L,H, xst,yst, f, ubot, utop, tend, dt)
...
[ux,uy] = flow_point(xtraj(1), ytraj(1), N,L,H, f, ubot, utop);
...
for i=3:Nt+1
    ...
    [ux2,uy2] = flow_point(xtraj(i-2), ytraj(i-2), N,L,H, f, ubot, utop);
